...
const CollectionNavigator = () => {
    ...
    return (
        <div className='flex flex-col gap-8 w-60 h-[95%] items-center my-10' style={{ border: 'solid #6B7274', borderWidth: '0px 2px 0px 0px' }}>
            <p className='text-gray-300 text-xl mb-5 underline underline-offset-8'>My Collection</p>

            <Link to="./expense" className="w-[80%]">
