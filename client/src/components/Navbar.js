...
export const Navbar = () => {
  ...
  return (
    <div className="box-border shadow-xl bg-grey flex items-center justify-between md:justify-between gap-3 py-2">
        
        <Link to="/">
          <img src={icon} className="w-[auto] h-[44px] lg:h-[52px] mb-[-4px] lg:mb-[-8px] ml-2 lg:ml-5 lg:mr-5"/>
        </Link>
      ...
      <div className="navRight mr-2 lg:mr-5">
        {!authenticated ? (
          <div style={{ textDecoration: "none" }} >
            <Link to="/Login" className="text-white bg-dark px-4 lg:px-5 py-2 lg:py-3 mr-2 rounded text-md">Login</Link>
          </div>
        ) : (
          <>
